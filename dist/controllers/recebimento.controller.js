...
var _recebimento = _interopRequireDefault(require("../models/recebimento"));
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _recebimento["default"].findAll();

          case 2:
            recebimentos = _context.sent;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return _recebimento["default"].findOne({
              where: {
                id: id
              }
            });
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return _recebimento["default"].create({
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.prev = 1;
            _context4.next = 4;
            return _recebimento["default"].destroy({
              where: {
                id: id
              }
            });
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.prev = 1;
            _context5.next = 4;
            return _recebimento["default"].update({
              parcela: req.body.parcela,
              valor_total: req.body.valor_total,
              tipo_recebimento: req.body.tipo_recebimento
            }, {
